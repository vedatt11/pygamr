...
def draw_backgrounds():
    ...
    title_text=title_font.render('The Matching Games',True,black)
...
while running:
    ...
    if matches==rows * cols//2:
        ...
        winner_text=title_font.render(f'You won in {score} noves!',True,white)
